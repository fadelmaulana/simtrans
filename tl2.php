	...
	<div class="container">
		...
		<table class="table table-bordered table-hover table-striped">
			...
			<tbody>
				...
				$query = $koneksi->query("SELECT * FROM trafficlight ORDER BY id_loc ASC");
				//jika ada datanya
				if($query->num_rows){
					...
					while($row = $query->fetch_assoc()){
						...
						<tr>
							...
							<td>
								...
								<button type="button" class="view_data btn btn-primary btn-xs" data-toggle="modal" id="'.$row['id_loc'].'" data-target="#myModal">Lihat data</button>
							</td>
						</tr>
						';
						// increase nomor
