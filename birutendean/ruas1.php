						...
						<div class="col-md-12">
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Koordinat Ruas Jalan "Dusun Kali - Pagar Ruyung"</h2>
								</header>
...
$result = mysqli_query($koneksi, "SELECT * FROM ruas1 ORDER BY id ASC");
?>
<div class="col-lg-4">
            <a href="bankdata.php">Bank Data</a><br/>
            <a href="tambahkoordinatruas1.php">Tambah Koordinat</a><br/><br/>
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    ...
                    while($user_data = mysqli_fetch_array($result)) {
                        ...
                        <a href='editkoordinatruas1.php?id=$user_data[id]'><i class='fa fa-pencil'></i></a>
                        <a href='hapuskoordinatruas1.php?id=$user_data[id]' class='delete-row'><i class='fa fa-trash-o'></i></a>
                        </td></tr>";
                    }
                    ?>
                </tbody>
...
$query = mysqli_query($koneksi,"SELECT titikawalx, titikawaly, titikakhirx, titikakhiry FROM bankdata WHERE id_ruas='K-001'");
...
$query = mysqli_query($koneksi,"SELECT lat, lng FROM ruas1");
