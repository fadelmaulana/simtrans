					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right" style="padding-right: 20px">
							<ol class="breadcrumbs">
								...
								<li><span>Dashboard / Dokumentasi / Video / Tambah Data Video</span></li>
                            </ol>
						</div>
					</header>
						...
						<div class="col-md-12">
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Tambah Dokumentasi Foto Ruas Jalan</h2>
								</header>
...
?>
	...
	<tr>
        ...
        $carikode = mysqli_query($connect, "SELECT no from foto") or die (mysqli_error());
          // menjadikannya array
        ...
        ?>
		<td>NO</td>
		<td><input type="text" name="no" value="<?php echo $kode_otomatis;?>"></td>
	</tr>
	<tr>
		<td>ID Ruas</td>
		<td>
                <select id="id_ruas" name="id_ruas">
                    <option value="">Pilih ID Ruas</option>
                    <?php
