                                    ...
                                    ?>
                                        <form class="form-horizontal" method="post" action="proses_simpan.php" enctype="multipart/form-data">
											<div class="form-group">
												<label class="col-md-2 control-label" for="inputReadOnly">No</label>
												<div class="col-md-2">
													<input type="text" name="id" value="<?php echo autonumber("tematikanalog","id",1 ,""); ?>" class="form-control input-rounded" readonly="readonly">
												</div>
											</div>

											<div class="form-group">
												<label class="col-md-2 control-label" for="inputKeterangan">Foto</label>
												<div class="col-md-1">
											...
											<div class="form-group">
												<label class="col-md-2 control-label" for="inputKeterangan">Keterangan</label>
												<div class="col-md-6">
													<input type="text" name="keterangan" class="form-control input-rounded">
												</div>
											</div>
                                            
                                        <hr>
                                        <input type="submit" value="Simpan" class="mb-xs mt-xs mr-xs btn btn-success">
                                        </form>
                                    <a href="../../data">tes</a>
								</div>
							</section>
