							...
							<nav id="menu" class="nav-main" role="navigation">
								<ul class="nav nav-main">
									...
									<li class="nav-parent">
										<a>
											<i class="fa fa-car" aria-hidden="true"></i>
											<span>Unduh / Unggah Data</span>
										</a>
                                        <ul class="nav nav-children">
											<li class="nav-parent">
												<a>Unggah (Upload) Data</a>
												<ul class="nav nav-children">
													<li class="nav-parent">
														<a>Darat</a>
														<ul class="nav nav-children">
													...
													<li class="nav-parent">
														...
														<ul class="nav nav-children">
															<li>
																<a>Bandara Udara Fatmawati Soekarno Bengkulu</a>
															</li>
														</ul>
													</li>
												</ul>
                        ...
                        <div class="col-md-6">
							<section class="panel">
                                ...
                                <table class="table table-striped" width="100%">
                                    ...
                                    <?php
                                    include('config.php');
                                    $sql = mysql_query("SELECT * FROM file ORDER BY id DESC");
                                    if(mysql_num_rows($sql) > 0){
                                        ...
                                        while($data = mysql_fetch_assoc($sql)){
                                            echo "<tr bgcolor='#fff'>";
                                                ...
                                                <td><a href="<?php echo $data['file']; ?>"><?php echo $data['nama_file']; ?></a></td>
                                                ...
                                                <td align="center">
                                                    <a href="proses_hapus.php?id=<?php echo $data['id']; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus data?')">
