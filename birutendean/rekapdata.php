					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right" style="padding-right: 20px">
							<ol class="breadcrumbs">
								...
								<li><span>Dashboard / Rekapitulasi Data</span></li>
                            </ol>
						</div>
					</header>
						...
						<div class="col-md-12">
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Rekapitulasi Data</h2>
								</header>
...
<form action="rekapdata.php" enctype="multipart/form-data" method="post">
...
echo "<br>File terunggah : <br>";
 while(list($index, $nama_file) = each($file_array))
  {
   $nomor = $index + 1;
   echo "$nomor. <a href='$nama_file'>$nama_file</a><br/>";
 }
