					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right" style="padding-right: 20px">
							<ol class="breadcrumbs">
								...
								<li><span>Dashboard / Bank Data / Edit Koordinat Ruas</span></li>
                            </ol>
						</div>
					</header>
						...
						<div class="col-md-12">
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Edit Koordinat Ruas Jalan "Dusun Kali - Pagar Ruyung"</h2>
								</header>
...
$result = mysqli_query($koneksi, "SELECT * FROM ".$_GET["noruas"]." WHERE id=$id");
...
<div class="col-lg-4">
	...
	<br/><br/>
	<form name="update_user" method="post" action="editkoordinat.php?noruas=<?php if(isset($_GET['noruas'])){ $no_ruas = $_GET['noruas']; } ?><?php echo $no_ruas ?>&id=<?php echo $id;?>">
        <div class="form-group">
            <label>No Ruas</label>
            <input class="form-control" type="text" name="id" value="<?php echo $_GET['id'];?>" readonly>
        </div>
        <div class="form-group">
            <label>Latitude</label>
            <input class="form-control" type="text" name="lat" value="<?php echo $lat;?>">
        </div>
        <div class="form-group">
            <label>Longitude</label>
            <input class="form-control" type="text" name="lng" value="<?php echo $lng;?>">
        </div>
        <div class="form-group">
            ...
            if(isset($_POST['update']))
            {
                ...
                // update user data
                $result = mysqli_query($koneksi, "UPDATE ".$_GET["noruas"]." SET lat='$lat',lng='$lng' WHERE id=$id");
                
                // Show message when data added
                echo "Koordinat Berhasil Diubah !";
            }
            ?>
        </div>
	</form>
