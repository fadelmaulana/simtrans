...
$sql = "SELECT * FROM warnlight WHERE id_loc=$id";
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right" style="padding-right: 20px">
							<ol class="breadcrumbs">
                                ...
                                <li><span>Edit Info dan Lokasi Warning Light</span></li>
                            </ol>
						</div>
					</header>
                    ...
                    <!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Edit Info dan Lokasi Warning Light</h2>
							</header>
							<div class="panel-body">
                                ...
                                <form class="form-horizontal" action="proses-edit-wl.php" method="POST">
                                    <input type="hidden" name="id_loc" value="<?php echo $siswa['id_loc'] ?>" />
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="nama">Lokasi</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="lokasi" value="<?php echo $siswa['lokasi'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="kota">Kabupaten</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="kabupaten" value="<?php echo $siswa['kabupaten'] ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="provinsi">Keterangan</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="keterangan" value="<?php echo $siswa['keterangan'] ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
