...
$sql = "SELECT * FROM macet WHERE id_loc=$id";
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right" style="padding-right: 20px">
							<ol class="breadcrumbs">
                                ...
                                <li><span>Edit Info dan Lokasi Titik Rawan</span></li>
                            </ol>
						</div>
					</header>
                    ...
                    <!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Edit Info dan Lokasi Titik Rawan</h2>
							</header>
							<div class="panel-body">
                                ...
                                <form class="form-horizontal" action="proses-edit-tr.php" method="POST">
