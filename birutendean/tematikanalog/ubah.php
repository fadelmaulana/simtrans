                        ...
                        <div class="col-md-6">
							<section class="panel">
								<header class="panel-heading">
                                    ...
                                    ?>
									<h2 class="panel-title">Ubah Data <?php echo $data['keterangan']; ?></h2>
								</header>
                                ...
                                <form class="form-horizontal" method="post" action="proses_ubah.php?id=<?php echo $id; ?>" enctype="multipart/form-data">
								    <div class="form-group">
									   ...
									   <div class="col-md-6">
										  <input type="text" name="keterangan" class="form-control input-rounded" value="<?php echo $data['keterangan']; ?>">
									   </div>
								    </div>
									<div class="form-group">
										<label class="col-md-2 control-label" for="inputKeterangan">Foto</label>
										<div class="col-md-4">
                                            <img src="images/<?php echo $data['foto']; ?>" width='200'>
											<input type="file" name="foto" class="form-control-file">
                                            <input type="checkbox" name="ubah_foto" value="true"> Ceklis jika ingin mengubah foto<br>
										</div>
									</div>
                                <hr>
                                    <input type="submit" value="Ubah" class="mb-xs mt-xs mr-xs btn btn-success">
                                </form>
								</div>
							</section>
						</div>
