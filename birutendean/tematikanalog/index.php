                        ...
                        <div class="col-md-6">
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Tematik Analog</h2>
								</header>
								<div class="panel-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="mb-md">
                                                <a style="color:#fff" href="tambah.php">
                                ...
                                <hr>
                                    ...
                                    <tr>
                                        ...
                                        <th style="padding:5px;width:50px;">Aksi</th>
                                    </tr>
                                    <?php
                                    // Load file koneksi.php
                                    include "koneksi.php";

                                    $query = "SELECT * FROM tematikanalog"; // Query untuk menampilkan semua data siswa
                                    $sql = mysqli_query($connect, $query); // Eksekusi/Jalankan query dari variabel $query

                                    while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
                                        echo "<tr>";
                                        echo "<td style='width:200px;padding:5px;'><img src='images/".$data['foto']."' width='200'></td>";
                                        echo "<td style='padding:5px;'>".$data['keterangan']."</td>";
                                        ?>
                                        <td style='padding:5px;'><a href="ubah.php?id=<?php echo $data['id']; ?>"><i class='fa fa-pencil'></i></a> | <a href="proses_hapus.php?id=<?php echo $data['id']; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus data?')"><i class='fa fa-trash-o'></i></a></td>
                                        <?php
                                        echo "</tr>";
                                    }
                                    ?>
