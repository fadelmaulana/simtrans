				...
				<aside id="sidebar-left" class="sidebar-left">
					...
					<div class="nano">
						<div class="nano-content">
                            ...
                            <!-- start: footer -->
                            <div style="position:fixed;bottom:0;left:0;text-align:center;width:300px;color:#abb4be;padding:10px;">
                                SIMTRANS
                                &copy 2018<br>
										...
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Pengunjung Dashboard SIMTRANS</h4>
														<div class="info">
									...
									<section class="panel panel-featured-left panel-featured-secondary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Pengunjung SIMTRANS Laut</h4>
														<div class="info">
															<strong class="amount">1234</strong>
														</div>
													</div>
													<div class="summary-footer">
													</div>
									...
									<section class="panel panel-featured-left panel-featured-tertiary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Pengunjung SIMTRANS Udara</h4>
														<div class="info">
									...
									<section class="panel panel-featured-left panel-featured-quartenary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Pengunjung SIMTRANS Darat</h4>
														<div class="info">
									...
									<section class="panel panel-featured-left panel-featured-quartenary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Total Semua Pengunjung</h4>
														<div class="info">
															<strong class="amount">3765</strong>
														</div>
													</div>
