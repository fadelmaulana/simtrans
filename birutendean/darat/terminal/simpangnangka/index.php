					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right" style="padding-right: 20px">
							<ol class="breadcrumbs">
                                ...
                                <li><span>Tipe B</span></li>
                                <li><span>Simpang Nangka</span></li>
                            </ol>
						</div>
					</header>
                    ...
                    <!-- start: page1 -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Terminal Simpang Nangka</h2>
							</header>
                                ...
                                <table class="table table-bordered table-striped" id="datatable-editable">
                                    ...
                                    <tbody>
                                        ...
                                        while($data = mysqli_fetch_array($query)){
                                            ...
                                            echo "<td>".$data['no']."</td>";
                                            echo "<td style='text-align:center'>".$data['noform']."</td>";
                                            echo "<td>".$data['tanggal']."</td>";
                                            echo "<td>".$data['pengisi']."</td>";
                                            echo "<td>".$data['lokasi']."</td>";
                                            echo "<td>".$data['namapo']."</td>";
                                            echo "<td>".$data['nokendaraan']."</td>";
                                            echo "<td>".$data['jeniskendaraan']."</td>";
                                            echo "<td>".$data['jenistrayek']."</td>";
                                            echo "<td>".$data['sanksi']."</td>";
                                            echo "<td>".$data['warna']."</td>";

                                            echo "<td style='text-align:center'>";
                                            echo "<a href='edit.php?no=".$data['no']."'><i class='fa fa-edit'></i></a> | ";
                                            ?>
                                        <a href="javascript:confirmDelete('hapus.php?no=<?php echo $data['no']; ?>')" ><i class='fa fa-trash'></i></a>
                                        <?php
