...
$sql = "SELECT * FROM angkot WHERE no=$id";
                    ...
                    <!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Edit Info dan Lokasi Traffic Light</h2>
							</header>
							<div class="panel-body">
                                ...
                                <form class="form-horizontal" action="proses-edit.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="nama">Kode Angkutan</label>
                                        <div class="col-md-2">
                                            <input class="form-control input-rounded" type="text" name="kodeangkutan" value="<?php echo $siswa['kodeangkutan'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="kota">Jurusan</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="jurusan" value="<?php echo $siswa['jurusan'] ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="provinsi">Melewati</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="melewati" value="<?php echo $siswa['melewati'] ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="latitude">Tarif Pelajar</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="tarifpelajar" value="<?php echo $siswa['tarifpelajar'] ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="logitude">Tarif Mahasiswa</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="tarifmahasiswa"  value="<?php echo $siswa['tarifmahasiswa'] ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="logitude">Tarif Dewasa</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="tarifdewasa"  value="<?php echo $siswa['tarifdewasa'] ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="logitude">Warna</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="warna"  value="<?php echo $siswa['warna'] ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="submit"></label>
                                        <div class="col-md-2">
                                            <input class="form-control btn btn-success" type="submit" value="Simpan" name="simpan" />
                                        </div>
                                    </div>
                                </form>
							</div>
