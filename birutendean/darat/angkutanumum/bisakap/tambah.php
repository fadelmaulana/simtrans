                    ...
                    <!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Angkutan Kota - Tambah</h2>
							</header>
							<div class="panel-body">
                                ...
                                <form class="form-horizontal" action="proses-tambah.php" method="POST">
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="nama">No</label>
                                        <div class="col-md-2">
                                            <input class="form-control input-rounded" maxlength="2" type="text" name="no" placeholder="Nomor">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="kota">Kode Angkutan</label>
                                        <div class="col-md-2">
                                            <input class="form-control input-rounded" maxlength="2" type="text" name="kodeangkutan" placeholder="Kode Angkutan" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="provinsi">Jurusan</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="jurusan" placeholder="Masukkan jurusan" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="latitude">Melewati</label>
                                        <div class="col-md-6">
                                            <textarea class="form-control input-rounded" type="text" name="melewati" placeholder="Masukkan rute yang dilewati" rows="3"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="logitude">Tarif Pelajar</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="tarifpelajar" placeholder="Masukkan tarif pelajar"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="logitude">Tarif Mahasiswa</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="tarifmahasiswa" placeholder="Masukkan tarif mahasiswa"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="logitude">Tarif Dewasa</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="tarifdewasa" placeholder="Masukkan tarif dewasa"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Warna</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="warna" data-plugin-colorpicker class="colorpicker-default form-control" value="#ffffff"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
