                    ...
                    <!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">DAMRI - Tambah (Bengkulu -> Lubuk Pinang)</h2>
							</header>
							<div class="panel-body">
                                ...
                                <form class="form-horizontal" action="proses-tambah-bkllbkpinang.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="tujuan" placeholder="Masukkan Nama Halte" />
                                        </div>
                                    </div>
                                    <div class="form-group">
