                    ...
                    <!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">DAMRI - Tambah (Bengkulu -> Tasikmalaya)</h2>
							</header>
							<div class="panel-body">
                                ...
                                <form class="form-horizontal" action="proses-tambah-bkltasik.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="tarifac" placeholder="Masukkan tarif pelajar"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="logitude">Tarif AC+Toilet</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="tarifactoilet" placeholder="Masukkan tarif mahasiswa"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
