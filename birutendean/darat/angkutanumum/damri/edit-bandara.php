...
$sql = "SELECT * FROM damrisungaihitamrinci WHERE no=$id";
                    ...
                    <!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Edit Data DAMRI (Bandara)</h2>
							</header>
							<div class="panel-body">
                                ...
                                <form class="form-horizontal" action="proses-edit-bandara.php" method="POST">
