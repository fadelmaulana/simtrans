...
$sql = "SELECT * FROM damriengganorinci WHERE no=$id";
                    ...
                    <!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Edit Data DAMRI (Enggano)</h2>
							</header>
							<div class="panel-body">
                                ...
                                <form class="form-horizontal" action="proses-edit-enggano.php" method="POST">
