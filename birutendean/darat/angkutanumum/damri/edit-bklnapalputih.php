...
$sql = "SELECT * FROM damribklnapalrinci WHERE no=$id";
                    ...
                    <!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Edit Data DAMRI (Bengkulu -> Napal Putih)</h2>
							</header>
							<div class="panel-body">
                                ...
                                <form class="form-horizontal" action="proses-edit-bklnapalputih.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="tarifekonomi" value="<?php echo $data['tarifekonomi'] ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
