...
$sql = "SELECT * FROM damribklmuarasahungrinci WHERE no=$id";
                    ...
                    <!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Edit Data DAMRI (Bengkulu -> Muara Sahung)</h2>
							</header>
							<div class="panel-body">
                                ...
                                <form class="form-horizontal" action="proses-edit-bklmuarasahung.php" method="POST">
                                    <input type="hidden" name="no" value="<?php echo $data['no'] ?>" />
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="nama">Dari</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="dari" value="<?php echo $data['dari'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="kota">Tujuan</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="tujuan" value="<?php echo $data['tujuan'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="provinsi">Jam Keberangkatan</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="jamkeberangkatan" value="<?php echo $data['jamkeberangkatan'] ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="latitude">Tarif Ekonomi</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="tarifeko" value="<?php echo $data['tarifekonomi'] ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="logitude">Tarif AC</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="tarifac"  value="<?php echo $data['tarifac'] ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
