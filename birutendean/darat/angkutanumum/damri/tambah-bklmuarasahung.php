                    ...
                    <!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">DAMRI - Tambah (Bengkulu -> Muara Sahung)</h2>
							</header>
							<div class="panel-body">
                                ...
                                <form class="form-horizontal" action="proses-tambah-bklmuarasahung.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="kota">Dari</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="dari" placeholder="Masukkan Nama Halte" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="provinsi">Tujuan</label>
                                        <div class="col-md-6">
                                            <textarea class="form-control input-rounded" type="text" name="tujuan" placeholder="Masukkan rute yang dilewati" rows="3"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="latitude">Jam Keberangkatan</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="jamkeberangkatan" placeholder="Masukkan jurusan" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="logitude">Tarif Ekonomi</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="tarifekonomi" placeholder="Masukkan tarif pelajar"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="logitude">Tarif AC</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="tarifac" placeholder="Masukkan tarif mahasiswa"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
