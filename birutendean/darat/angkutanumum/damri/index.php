					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right" style="padding-right: 20px">
							<ol class="breadcrumbs">
                                ...
                                <li><span>Angkutan Umum</span></li>
                                <li><span>DAMRI</span></li>
                            </ol>
						</div>
					</header>
                    ...
                    <!-- start: page1 -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Bengkulu - Lubuk Pinang</h2>
							</header>
							<div class="panel-body" style="display:none;">
								<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
                                            <a style="color:#fff" href="tambah-bkllbkpinang.php">
                                ...
                                <table class="table table-bordered table-striped" id="datatable-editable">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = "SELECT * FROM damribkllubukpinangrinci";
                                        ...
                                        while($data1 = mysqli_fetch_array($query)){
                                            ...
                                            echo "<a href='edit-bkllbkpinang.php?no=".$data1['no']."'><i class='fa fa-edit'></i></a> | ";
                                            ?>
                                            <a href="javascript:confirmDelete('hapus-bkllbkpinang.php?no=<?php echo $data1['no']; ?>')" ><i class='fa fa-trash'></i></a>
                    ...
                    <!-- start: page2 -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Bengkulu - Muara Sahung</h2>
							</header>
							<div class="panel-body" style="display:none;">
								<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
                                            <a style="color:#fff" href="tambah-bklmuarasahung.php">
                                                <button class="btn btn-primary">Tambah <i class="fa fa-plus"></i></button>
                                            </a>
										</div>
									</div>
                                ...
                                <table class="table table-bordered table-striped" id="datatable-editable">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = "SELECT * FROM damribklmuarasahungrinci";
                                        $query = mysqli_query($koneksi, $sql);
                                        ...
                                        while($data1 = mysqli_fetch_array($query)){
                                            ...
                                            echo "<td style='text-align:center'>";
                                            echo "<a href='edit-bklmuarasahung.php?no=".$data1['no']."'><i class='fa fa-edit'></i></a> | ";
                                            ?>
                                        <a href="javascript:confirmDelete('hapus-bklmuarasahung.php?no=<?php echo $data1['no']; ?>')" ><i class='fa fa-trash'></i></a>
                                        <?php
                    ...
                    <!-- start: page3 -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Bengkulu - Napal Putih</h2>
							</header>
							<div class="panel-body" style="display:none;">
								<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
                                            <a style="color:#fff" href="tambah-bklnapalputih.php">
                                                <button class="btn btn-primary">Tambah <i class="fa fa-plus"></i></button>
                                            </a>
										</div>
									</div>
                                ...
                                <table class="table table-bordered table-striped" id="datatable-editable">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = "SELECT * FROM damribklnapalrinci";
                                        $query = mysqli_query($koneksi, $sql);
                                        ...
                                        while($data1 = mysqli_fetch_array($query)){
                                            ...
                                            echo "<td style='text-align:center'>";
                                            echo "<a href='edit-bklnapalputih.php?no=".$data1['no']."'><i class='fa fa-edit'></i></a> | ";
                                            ?>
                                        <a href="javascript:confirmDelete('hapus-bklnapalputih.php?no=<?php echo $data1['no']; ?>')" ><i class='fa fa-trash'></i></a>
                                        <?php
                    ...
                    <!-- start: page4 -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Bengkulu - Tasikmalaya</h2>
							</header>
							<div class="panel-body" style="display:none;">
								<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
                                            <a style="color:#fff" href="tambah-bkltasik.php">
                                                <button class="btn btn-primary">Tambah <i class="fa fa-plus"></i></button>
                                            </a>
										</div>
									</div>
                                ...
                                <table class="table table-bordered table-striped" id="datatable-editable">
                                    <thead>
                                        ...
                                        <tr>
                                            <td style="vertical-align:middle;" class="text-center">AC</td>
                                            <td style="vertical-align:middle;" class="text-center">AC +Toilet</td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                        $sql = "SELECT * FROM damribkltasikrinci";
                                        $query = mysqli_query($koneksi, $sql);

                                        while($data1 = mysqli_fetch_array($query)){
                                            $hargatarifac=number_format($data1['tarifac'],0,",",".");
                                            $hargatarifactoilet=number_format($data1['tarifactoilet'],0,",",".");
                                            echo "<tr>";
                                            ...
                                            echo "<td style='vertical-align:middle' class='text-center'>".$data1['jamkeberangkatan']."</td>";
                                            echo "<td>Rp. $hargatarifac</td>";
                                            echo "<td>Rp. $hargatarifactoilet</td>";

                                            echo "<td style='text-align:center'>";
                                            echo "<a href='edit-bkltasik.php?no=".$data1['no']."'><i class='fa fa-edit'></i></a> | ";
                                            ?>
                                        <a href="javascript:confirmDelete('hapus-bkltasik.php?no=<?php echo $data1['no']; ?>')" ><i class='fa fa-trash'></i></a>
                                        <?php
                    ...
                    <!-- start: page5 -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Enggano</h2>
							</header>
							<div class="panel-body" style="display:none;">
								<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
                                            <a style="color:#fff" href="tambah-enggano.php">
                                                <button class="btn btn-primary">Tambah <i class="fa fa-plus"></i></button>
                                            </a>
										</div>
									</div>
                                ...
                                <table class="table table-bordered table-striped" id="datatable-editable">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = "SELECT * FROM damriengganorinci";
                                        $query = mysqli_query($koneksi, $sql);
                                        ...
                                        while($data1 = mysqli_fetch_array($query)){
                                            ...
                                            echo "<td style='text-align:center'>";
                                            echo "<a href='edit-enggano.php?no=".$data1['no']."'><i class='fa fa-edit'></i></a> | ";
                                            ?>
                                        <a href="javascript:confirmDelete('hapus-enggano.php?no=<?php echo $data1['no']; ?>')" ><i class='fa fa-trash'></i></a>
                                        <?php
                    ...
                    <!-- start: page6 -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Sungai Hitam - Bandara</h2>
							</header>
							<div class="panel-body" style="display:none;">
								<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
                                            <a style="color:#fff" href="tambah-bandara.php">
                                                <button class="btn btn-primary">Tambah <i class="fa fa-plus"></i></button>
                                            </a>
										</div>
									</div>
                                ...
                                <table class="table table-bordered table-striped" id="datatable-editable">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = "SELECT * FROM damrisungaihitamrinci";
                                        $query = mysqli_query($koneksi, $sql);
                                        ...
                                        while($data1 = mysqli_fetch_array($query)){
                                            ...
                                            echo "<td style='text-align:center'>";
                                            echo "<a href='edit-bandara.php?no=".$data1['no']."'><i class='fa fa-edit'></i></a> | ";
                                            ?>
                                        <a href="javascript:confirmDelete('hapus-bandara.php?no=<?php echo $data1['no']; ?>')" ><i class='fa fa-trash'></i></a>
                                        <?php
