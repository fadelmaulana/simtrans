...
$sql = "SELECT * FROM damribkltasikrinci WHERE no=$id";
                    ...
                    <!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Edit Data DAMRI (Bengkulu -> Tasikmalaya)</h2>
							</header>
							<div class="panel-body">
                                ...
                                <form class="form-horizontal" action="proses-edit-bkltasik.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="latitude">Tarif AC</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="tarifactoilet"  value="<?php echo $data['tarifactoilet'] ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
