                    ...
                    <!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Bus Rapid Transit (BRT) - Tambah</h2>
							</header>
							<div class="panel-body">
                                ...
                                <form class="form-horizontal" action="proses-tambah.php" method="POST">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-2">
                                            <input class="form-control input-rounded" maxlength="10" type="text" name="no" placeholder="Nomor">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="kota">Nama Halte</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="halte" placeholder="Masukkan Nama Halte" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="provinsi">Rute</label>
                                        <div class="col-md-6">
                                            <textarea class="form-control input-rounded" type="text" name="rute" placeholder="Masukkan rute yang dilewati" rows="3"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="latitude">Jam Operasi</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="jamoperasi" placeholder="Masukkan jurusan" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="logitude">Tarif</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="tarif" placeholder="Masukkan tarif pelajar"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="logitude">Latitude</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="lat" placeholder="Masukkan tarif mahasiswa"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="logitude">Longitude</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="lng" placeholder="Masukkan tarif dewasa"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
