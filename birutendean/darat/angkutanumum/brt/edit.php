...
$sql = "SELECT * FROM brt WHERE no=$id";
                    ...
                    <!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Edit Data Bus Rapid Transit (BRT)</h2>
							</header>
							<div class="panel-body">
                                ...
                                <form class="form-horizontal" action="proses-edit.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="nama">Nama Halte</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="halte" value="<?php echo $data['halte'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="kota">Rute</label>
                                        <div class="col-md-6">
                                            <textarea class="form-control input-rounded" type="text" name="rute" rows="3"><?php echo $data['rute'] ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="provinsi">Jam Operasi</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="jamoperasi" value="<?php echo $data['jamoperasi'] ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="latitude">Tarif</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="tarif" value="<?php echo $data['tarif'] ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="logitude">Latitude</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="latitude"  value="<?php echo $data['lat'] ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="logitude">Longitude</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="longitude"  value="<?php echo $data['long'] ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
