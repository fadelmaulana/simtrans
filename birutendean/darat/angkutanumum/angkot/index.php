                    ...
                    <!-- start: page1 -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Angkutan Kota</h2>
							</header>
                                ...
                                <table class="table table-bordered table-striped" id="datatable-editable">
                                    ...
                                    <tbody>
                                        ...
                                        while($data = mysqli_fetch_array($query)){
                                            ...
                                            echo "<td>".$data['no']."</td>";
                                            echo "<td style='text-align:center'>".$data['kodeangkutan']."</td>";
                                            echo "<td>".$data['jurusan']."</td>";
                                            echo "<td>".$data['melewati']."</td>";
                                            echo "<td>Rp. ".$data['tarifpelajar']."</td>";
                                            echo "<td>Rp. ".$data['tarifmahasiswa']."</td>";
                                            echo "<td>Rp. ".$data['tarifdewasa']."</td>";
                                            echo "<td>".$data['warna']."</td>";

                                            echo "<td style='text-align:center'>";
                                            echo "<a href='edit.php?no=".$data['no']."'>Edit</a> | ";
                                            ?>
                                        <a href="javascript:confirmDelete('hapus.php?no=<?php echo $data['no']; ?>')" >Hapus</a>
                                        <?php
