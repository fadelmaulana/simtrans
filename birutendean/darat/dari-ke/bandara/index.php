					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right" style="padding-right: 20px">
							<ol class="breadcrumbs">
                                ...
                                <li><span>Angkutan Dari/Ke</span></li>
                                <li><span>Bandara</span></li>
                            </ol>
						</div>
					</header>
                    ...
                    <!-- start: page1 -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Angkutan Dari/Ke Bandara</h2>
							</header>
                                ...
                                <table class="table table-bordered table-striped" id="datatable-editable">
                                    ...
                                    <tbody>
                                        ...
                                        while($data = mysqli_fetch_array($query)){
                                            ...
                                            echo "<td>".$data['no']."</td>";
                                            echo "<td style='text-align:center'>".$data['perjalanan']."</td>";
                                            echo "<td>".$data['titikmuat']."</td>";
