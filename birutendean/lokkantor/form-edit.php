					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right" style="padding-right: 20px">
							<ol class="breadcrumbs">
								...
								<li><span>GIS</span></li>
                                <li><span>Lokasi Kantor</span></li>
                                <li><span>Edit Info dan Lokasi Kantor</span></li>
                            </ol>
						</div>
					</header>
                    ...
                    <!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Edit Info dan Lokasi Kantor</h2>
							</header>
							<div class="panel-body">
                                ...
                                <form class="form-horizontal" action="proses-edit.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="nama" value="<?php echo $siswa['nama'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="kota">Kota</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="kota" value="<?php echo $siswa['kota'] ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="provinsi">Provinsi</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="provinsi" value="<?php echo $siswa['provinsi'] ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="alamat">Alamat</label>
                                        <div class="col-md-6">
                                            <textarea class="form-control" rows="3" name="alamat"><?php echo $siswa['alamat'] ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="notelp">No Telp</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="no_hp" value="<?php echo $siswa['no_hp'] ?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="website">Website</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="website" value="<?php echo $siswa['website'] ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="latitude">Latitude</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="lat" value="<?php echo $siswa['lat'] ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="logitude">Logitude</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="lng"  value="<?php echo $siswa['lng'] ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
