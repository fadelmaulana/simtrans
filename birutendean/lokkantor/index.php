                    ...
                    <!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Lokasi Kantor</h2>
							</header>
							<div class="panel-body">
								<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
                                            <a style="color:#fff" href="form-tambah.php">
                                ...
                                <table class="table table-bordered table-striped mb-none" id="datatable-editable">
                                    ...
                                    <tbody>
                                        ...
                                        while($siswa = mysqli_fetch_array($query)){
                                            ...
                                            echo "<td><a target='_blank' href='http://".$siswa['website']."'>".$siswa['website']."</a></td>";
                                            echo "<td>".$siswa['lat']."</td>";
                                            echo "<td>".$siswa['lng']."</td>";

                                            echo "<td>";
                                            echo "<a href='form-edit.php?id_loc=".$siswa['id_loc']."'><i class='fa fa-pencil'></i></a> | ";
                                            echo "<a href='hapus.php?id_loc=".$siswa['id_loc']."'><i class='fa fa-trash-o'></i></a>";
                                            echo "</td>";
