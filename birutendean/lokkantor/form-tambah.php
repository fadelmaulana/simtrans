					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right" style="padding-right: 20px">
							<ol class="breadcrumbs">
                                ...
                                <li><span>Tambah Lokasi Kantor</span></li>
                            </ol>
						</div>
					</header>
                    ...
                    <!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Tambah Lokasi Kantor</h2>
							</header>
							<div class="panel-body">
                                ...
                                <form class="form-horizontal" action="proses-tambah.php" method="POST">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="nama" placeholder="Nama Lokasi">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="kota">Kota</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="kota" placeholder="Nama Kota" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="provinsi">Provinsi</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="provinsi" placeholder="Nama Provinsi" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="no_hp" placeholder="Nomor Telpon"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="website">Website</label>
                                        <div class="col-md-6">
                                            <input class="form-control input-rounded" type="text" name="website" placeholder="Halaman Website" />
                                        </div>
                                    </div>
                                    <div class="form-group">
