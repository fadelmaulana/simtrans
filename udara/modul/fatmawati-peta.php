...
<html lang="en">
    ...
    <body>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="fatmawati-peta.php">Peta Bandara</a></li>
                                            <li><a href="../?menu=fatmawati-info#lalin">Data Info Bandara</a></li>
        ...
        <div class="container">
            <center>
                <h3>Peta Bandara Fatmawati Soekarno Bengkulu</h3><br>
            </center>
            <div class="demo-gallery">
                <ul id="lightgallery" class="row">
                    <li class="col-md-2" data-responsive="img/denah-dan-info.jpg" data-src="img/denah-dan-info.jpg" data-sub-html="<h4>Denah dan Informasi Umum</h4> <p>Bandara Fatmawati Soekarno Bengkulu</p>">
                        <a href="">
                            <img class="img-responsive" src="img/denah-dan-info.jpg">
                        </a>
                    </li>
                    <li class="col-md-2" data-responsive="img/fasilitas-dan-kantor-lt1.jpg" data-src="img/fasilitas-dan-kantor-lt1.jpg" data-sub-html="<h4>Fasilitas dan Kantor</h4><p>Gedung Terminal Lt.1</p>">
                        <a href="">
                            <img class="img-responsive" src="img/fasilitas-dan-kantor-lt1.jpg">
                        </a>
                    </li>
                    <li class="col-md-2" data-responsive="img/fasilitas-dan-konsesioner-lt2.jpg" data-src="img/fasilitas-dan-konsesioner-lt2.jpg" data-sub-html="<h4>Fasilitas dan Konsesioner</h4><p>Gedung Terminal Lt.2</p>">
                        <a href="">
                            <img class="img-responsive" src="img/fasilitas-dan-konsesioner-lt2.jpg">
                        </a>
                    </li>
                    <li class="col-md-2" data-responsive="img/konsesioner-gedung-terminal-lt1.jpg" data-src="img/konsesioner-gedung-terminal-lt1.jpg" data-sub-html="<h4>Konsesioner</h4><p>Gedung Terminal Lt.1</p>">
                        <a href="">
                            <img class="img-responsive" src="img/konsesioner-gedung-terminal-lt1.jpg">
                        </a>
                    </li>
                </ul>
            </div>
