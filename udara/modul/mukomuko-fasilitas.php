...
<center>
    <h3>Fasilitas Bandara Mukomuko</h3>
</center>
            ...
            <div class="container-fluid">
                <div id="atm" class="tabcontent">
                    ...
                    <div style="margin-top:10px;" class="row">
                        ...
                        $query = "SELECT * from mukomuko_fasilitas WHERE jenis = 'atm' ORDER by nama ASC"; // Query untuk menampilkan semua data
                ...
                <div id="parkir" class="tabcontent">
                    ...
                    <div style="margin-top:10px;" class="row">
                        ...
                        $query = "SELECT * from mukomuko_fasilitas WHERE jenis = 'parkir' ORDER by nama ASC"; // Query untuk menampilkan semua data
                        $sql = mysqli_query($koneksi, $query); // Eksekusi/Jalankan query dari variabel $query
                ...
                <div id="dropzone" class="tabcontent">
                    ...
                    <div style="margin-top:10px;" class="row">
                        ...
                        $query = "SELECT * from mukomuko_fasilitas WHERE jenis = 'dropzone' ORDER by nama ASC"; // Query untuk menampilkan semua data
                        $sql = mysqli_query($koneksi, $query); // Eksekusi/Jalankan query dari variabel $query
                ...
                <div id="kios" class="tabcontent">
                    ...
                    <div style="margin-top:10px;" class="row">
                        ...
                        $query = "SELECT * from mukomuko_fasilitas WHERE jenis = 'kios' ORDER by nama ASC"; // Query untuk menampilkan semua data
                        $sql = mysqli_query($koneksi, $query); // Eksekusi/Jalankan query dari variabel $query
                ...
                <div id="musholla" class="tabcontent">
                    ...
                    <div style="margin-top:10px;" class="row">
                        ...
                        $query = "SELECT * from mukomuko_fasilitas WHERE jenis = 'musholla' ORDER by nama ASC"; // Query untuk menampilkan semua data
                        $sql = mysqli_query($koneksi, $query); // Eksekusi/Jalankan query dari variabel $query
                ...
                <div id="waitingroom" class="tabcontent">
                    ...
                    <div style="margin-top:10px;" class="row">
                        ...
                        $query = "SELECT * from mukomuko_fasilitas WHERE jenis = 'waitingroom' ORDER by nama ASC"; // Query untuk menampilkan semua data
                        $sql = mysqli_query($koneksi, $query); // Eksekusi/Jalankan query dari variabel $query
                ...
                <div id="loket" class="tabcontent">
                    ...
                    <div style="margin-top:10px;" class="row">
                        ...
                        $query = "SELECT * from mukomuko_fasilitas WHERE jenis = 'loket' ORDER by nama ASC"; // Query untuk menampilkan semua data
                        $sql = mysqli_query($koneksi, $query); // Eksekusi/Jalankan query dari variabel $query
